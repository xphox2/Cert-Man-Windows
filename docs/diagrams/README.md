...
| Acmebot architecture | [Runbook 04](../../04-Azure-Acmebot-Runbook.md) | [src](src/runbook04-acmebot-arch.mmd) | [PNG](runbook04-acmebot-arch.png) · [SVG](runbook04-acmebot-arch.svg) |
